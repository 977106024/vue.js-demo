...
app = new _vue2.default({
    ...
    methods: {
        fetchTodos: function fetchTodos() {
            ...
            if (this.currentUser) {
                ...
                query.find().then(function (todos) {
                    ...
                    _this.todoList = JSON.parse(avAllTodos.attributes.content); //解析内容
                    _this.todoList.id = id; //给数组设置id
                }, function (error) {
                    console.log(error);
                });
            }
        ...
        updateTodos: function updateTodos() {
            ...
            var avTodos = _leancloudStorage2.default.Object.createWithoutData('AllTodos', this.todoList.id); //更新对象
        ...
        logout: function logout() {
            _leancloudStorage2.default.User.logOut(); //登出
